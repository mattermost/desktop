...
var SettingsPage = React.createClass({
  ...
  render: function() {
    ...
    if (process.platform === 'darwin' || process.platform === 'linux') {
      options.push(<Input key="inputShowTrayIcon" id="inputShowTrayIcon" ref="showTrayIcon" type="checkbox" label="Show tray icon (Need to restart the application)" checked={ this.state.showTrayIcon }
