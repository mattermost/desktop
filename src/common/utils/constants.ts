...
export const INTERNAL_PROTOCOL = 'mm-desktop';
export const DEFAULT_CSP_HEADER = `script-src 'self' ${INTERNAL_PROTOCOL}://mm-desktop-local/ {server-origin}; style-src 'self' {server-origin} 'unsafe-inline'; media-src data:`;
