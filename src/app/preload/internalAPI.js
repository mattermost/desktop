...
contextBridge.exposeInMainWorld('desktop', {
    ...
    findBar: {
        find: (text, options) => ipcRenderer.send(FIND_IN_PAGE, text, options),
        findNext: () => ipcRenderer.send(FIND_IN_PAGE_NEXT),
        findPrevious: () => ipcRenderer.send(FIND_IN_PAGE_PREV),
        close: () => ipcRenderer.send(FIND_BAR_CLOSE),
        onOpen: (listener) => ipcRenderer.on(FIND_BAR_OPEN, () => listener()),
        onFocus: (listener) => ipcRenderer.on(FIND_BAR_FOCUS, () => listener()),
        onResult: (listener) => ipcRenderer.on(FIND_BAR_RESULT, (_, result) => listener(result)),
    },
